...
handle_t* create_handle(const char* func_pathname, uint32_t func_type){
    ...
    if(func_type == 0){
        ...
        strcat(compile_cmd, " $SIMPLE_PIM_LIB/processing/map/map_dpu.c $SIMPLE_PIM_LIB/processing/ProcessingHelper.c -I$SIMPLE_PIM_LIB");
        ...
        strcat(compile_cmd, func_bodyname);
        strcat(compile_cmd, " $SIMPLE_PIM_LIB/processing/gen_red/gen_red_dpu.c $SIMPLE_PIM_LIB/processing/ProcessingHelper.c $SIMPLE_PIM_LIB/TableHost.c $SIMPLE_PIM_LIB/Table.c $SIMPLE_PIM_LIB/TableShared.c -I$SIMPLE_PIM_LIB");
        int succ = system(compile_cmd);
        ...
        strcat(compile_cmd, " $SIMPLE_PIM_LIB/processing/zip/zip_dpu.c $SIMPLE_PIM_LIB/processing/zip/ZipProcessing.c $SIMPLE_PIM_LIB/processing/ProcessingHelper.c -I$SIMPLE_PIM_LIB");
        int succ = system(compile_cmd);
